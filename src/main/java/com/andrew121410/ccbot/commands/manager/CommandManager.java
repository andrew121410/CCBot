...
public class CommandManager {
    ...
    public CommandManager(CCBot ccBot) {
        this.ccBot = ccBot;
        this.commandMap = this.ccBot.getSetListMap().getCommandMap();
        this.prefix = this.ccBot.getConfigManager().getMainConfig().getPrefix();
    }
